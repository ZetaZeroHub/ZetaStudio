...
const mazeLevels = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    enemies: [
      { type: 'worm', x: 700, y: 520, patrolRange: 60, tileId: 'worm_normal_rest' },
      { type: 'slime', x: 1300, y: 520, patrolRange: 100, tileId: 'slime_normal_rest' },
      { type: 'worm', x: 1900, y: 520, patrolRange: 60, tileId: 'worm_normal_rest' },
    ],
    ...
    interactables: [
      ...
      // 教学尖刺（拉开与弹簧间距避免堆叠）
      { type: 'spikes', x: 1120, y: 504, w: 32, h: 16, tileId: 'spikes' },
      // 弹簧
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    enemies: [
      { type: 'frog', x: 550, y: 520, patrolRange: 50, tileId: 'frog_idle' },
      { type: 'frog', x: 1500, y: 520, patrolRange: 60, tileId: 'frog_idle' },
      { type: 'slime', x: 1000, y: 520, patrolRange: 80, tileId: 'slime_normal_rest' },
      { type: 'slime', x: 2000, y: 520, patrolRange: 80, tileId: 'slime_normal_rest' },
      { type: 'frog', x: 2600, y: 520, patrolRange: 40, tileId: 'frog_idle' },
    ],
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    enemies: [
      { type: 'bee', x: 500, y: 300, patrolRange: 120, tileId: 'bee_rest' },
      { type: 'spider', x: 950, y: 520, patrolRange: 80, tileId: 'ladybug_rest' },
      { type: 'bat', x: 1200, y: 280, patrolRange: 100, tileId: 'fly_rest' },
      { type: 'spider', x: 1500, y: 520, patrolRange: 60, tileId: 'ladybug_rest' },
      { type: 'bat', x: 2000, y: 300, patrolRange: 100, tileId: 'fly_rest' },
      { type: 'slime', x: 2850, y: 520, patrolRange: 80, tileId: 'slime_normal_rest' },
    ],
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    enemies: [
      { type: 'worm', x: 650, y: 520, patrolRange: 60, tileId: 'worm_normal_rest' },
      { type: 'slime', x: 1000, y: 480, patrolRange: 80, tileId: 'slime_normal_rest' },
      { type: 'bat', x: 1600, y: 280, patrolRange: 120, tileId: 'fly_rest' },
      { type: 'bee', x: 1900, y: 260, patrolRange: 80, tileId: 'bee_rest' },
      { type: 'frog', x: 2900, y: 520, patrolRange: 50, tileId: 'frog_idle' },
      { type: 'snail', x: 3200, y: 520, patrolRange: 60, tileId: 'snail_rest' },
      { type: 'spider', x: 3500, y: 520, patrolRange: 50, tileId: 'ladybug_rest' },
      { type: 'bat', x: 3900, y: 300, patrolRange: 100, tileId: 'fly_rest' },
      { type: 'slime_fire', x: 4200, y: 520, patrolRange: 80, tileId: 'slime_fire_rest' },
    ],
